...
//	}
	...
	public AppiumDriverLocalService getAppiumService() {
		...
		environment.put("PATH",
				"/Users/souradeepghosh/Documents/apache-maven-3.6.3/bin:/Users/souradeepghosh/Library/Android/sdk/build-tools/29.0.3:/Users/souradeepghosh/Library/Android/sdk/tools:/Users/souradeepghosh/Library/Android/sdk/platform-tools:/Users/souradeepghosh/npm-global/bin/:/usr/local/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin"
						+ System.getenv("PATH"));
		environment.put("JAVA_HOME", "/Library/Java/JavaVirtualMachines/jdk1.8.0_241.jdk/Contents/Home");
		environment.put("ANDROID_HOME", "/Users/souradeepghosh/Library/Android/sdk");
		return AppiumDriverLocalService.buildService(new AppiumServiceBuilder()
				.usingDriverExecutable(new File("/usr/local/bin/node"))
				.withAppiumJS(new File("/Users/souradeepghosh/npm-global/lib/node_modules/appium/build/lib/main.js"))
				.usingPort(4723).withArgument(GeneralServerFlag.SESSION_OVERRIDE).withEnvironment(environment)
				.withLogFile(new File("ServerLogs/server.log")));
	}

	@Parameters({ "emulator", "platformName", "udid","portNumber", "deviceName", "systemPort", "chromeDriverPort", "wdaLocalPort",
			"webkitDebugProxyPort" })
	@BeforeTest
	public void beforeTest(@Optional("androidOnly") String emulator, String platformName, String udid,String portNumber,
		...
		try {
			...
			case "Android":
				...
				desiredCapabilities.setCapability(AndroidMobileCapabilityType.SYSTEM_PORT, portNumber);
